...
from config import (
    CRYSTAL_POSCAR, DISORDERED_POSCAR, DISORDERED_DIFFUSIVITY,
    DL_WORK_DIR, EXTRAPOLATION_VALUE,
)
...
plt.plot(interp_shifted_freq_crystal, interp_shifted_speed_crystal * 1e-3, color=Colors[3], label='reference crystal')
plt.plot(frequencies_plot_diff, np.sqrt(diffusivity_plot/lifetime_interpolated) * 1e-3, color=Colors[0], label='disordered system')
